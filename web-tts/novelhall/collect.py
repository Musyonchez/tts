...
The extension saves to: Downloads\novelhall-tts\
This script saves chapter text to novelhall\content\ and moves JSONs to processed\.

Usage:
    venv/Scripts/python.exe novelhall/collect.py
"""
...
DOWNLOADS_DIR = Path.home() / "Downloads" / "novelhall-tts"
