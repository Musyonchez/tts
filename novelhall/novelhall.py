"""
novelhall.py — Read saved chapter files aloud, auto-advancing to the next.

Usage:
    # Read a novel folder from chapter 1:
    venv/Scripts/python.exe novelhall/novelhall.py novelhall/content/<novel>

    # Start from a specific chapter:
    venv/Scripts/python.exe novelhall/novelhall.py novelhall/content/<novel>/chapter-0001.txt
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: novelhall.py <chapter.txt | novel-folder>")
